<template>
  <Teleport to="body">
    <div class="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div class="relative flex flex-col bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 modal-in max-h-[90vh]">
        ...
        <div v-if="$slots.footer" class="flex items-center justify-end gap-2 px-5 py-3 border-t border-border-default bg-bg-secondary rounded-b-lg shrink-0">
          <slot name="footer" />
        </div>
      </div>
    </div>
